$(function(){
    ...
    addInputsInDOM(tbody, nb, 'calcul w-100 small');
    nb++;
    ...
    */
    $('.add').click(function(){
        addInputsInDOM(tbody, nb, 'calcul w-100 small'); // On ajoute une nouvelle ligne 

        nb++; // On incrémente le compteur pour avoir des lignes différentes à chaque fois
        datacounter.setAttribute('data-counter', nb); // On met à jout le datacounter
    });
    /* 
    ...
    */
    ...
    $('.del').click(function(){
        ...
        inputreadonly.value = ''
        if (nb > 2) { // On autorise la suppression des tr s'il en a au moins 2
            removeInputsInDOM(tbody); // On supprime le dernier élément
            nb--; // On décrémente le compteur à chaque fois pour avoir la continuité de ligne et de savoir si le compteur est révenu à 1
            datacounter.setAttribute('data-counter', nb); // On met à jour le compteur de ligne
        }
    });
    /* 
